...
class AbstractDirectiveForecastingModel(AbstractForecastingModel, ABC):
    ...
    def build_train_test(self, future_points: int = 1, train_window: int = 1):
        train_x = np.array(list(more_itertools.windowed(self.time_series_values[0:-future_points], n=train_window)))
